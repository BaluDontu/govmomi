...
func CreatePbmCapabilityProfileSpec(pbmCreateSpec CapabilityProfileCreateSpec) (types.PbmCapabilityProfileCreateSpec, error) {
	var pbmCapabilityProfileSpec types.PbmCapabilityProfileCreateSpec
	capabilities, err := createCapabilityInstances(pbmCreateSpec.CapabilityList)
	if err != nil {
		return pbmCapabilityProfileSpec, err
	}
